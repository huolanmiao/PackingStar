...
The **Kissing Number** (denoted as $\tau(n)$ or $K(n)$) is defined as the maximum number of non-overlapping unit spheres that can simultaneously touch a central unit sphere in an $n$-dimensional Euclidean space. 
...
*Formulation used in our PackingStar Paper (arXiv:2511.13391v1)*
